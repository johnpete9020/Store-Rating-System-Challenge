...
const AdminDashboard = () => {
  ...
  const fetchOwners = async () => {
    try {
      const response = await axios.get('http://localhost:5000/api/admin/users?role=store_owner');
  ...
  const fetchUsersList = async () => {
    try {
      const response = await axios.get('http://localhost:5000/api/admin/users', { params: userFilters });
  ...
  const fetchStoresList = async () => {
    try {
      const response = await axios.get('http://localhost:5000/api/admin/stores', { params: storeFilters });
  ...
  const onAddStore = async (data) => {
    try {
      await axios.post('http://localhost:5000/api/stores', data);
